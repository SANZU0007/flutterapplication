...
class GridImportChart extends StatefulWidget {
  final Map<String, dynamic>? response;

  const GridImportChart({Key? key, this.response}) : super(key: key);

  @override
  _StringDataChartState createState() => _StringDataChartState();
}

class _StringDataChartState extends State<GridImportChart> {
  String apikey = '';
  ...
  Future<void> _fetchGraphData() async {
    final url =
        'https://esenz.live/esenzMobileAPISolarPowerHourlyRedirect.aspx?KEY=$apikey&SOURCE=WEB&POINTS=20&PARA=GRID_IMP&PERIOD=$period';
  ...
  Widget _buildPeriodButton(String periodLabel) {
    ...
    return Card(
      ...
      color: isSelected ? primaryColorbg : gridImportColor,
