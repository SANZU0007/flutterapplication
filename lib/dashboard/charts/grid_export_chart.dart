...
import 'package:testapp/dashboard/Grid_export_card_design.dart'; // Import syncfusion_flutter_charts

class GridExportchartData extends StatefulWidget {
  final Map<String, dynamic>? response;

  const GridExportchartData({Key? key, this.response}) : super(key: key);

  @override
  _StringDataChartState createState() => _StringDataChartState();
}

class _StringDataChartState extends State<GridExportchartData> {
  String apikey = '';
  ...
  Future<void> _fetchGraphData() async {
    final url =
        'https://esenz.live/esenzMobileAPISolarPowerHourlyRedirect.aspx?KEY=$apikey&SOURCE=WEB&POINTS=20&PARA=GRID_EXP&PERIOD=$period';
  ...
  Widget _buildPeriodButton(String periodLabel) {
    ...
    return Card(
      ...
      color: isSelected ? primaryColorbg : gridExportColor,
